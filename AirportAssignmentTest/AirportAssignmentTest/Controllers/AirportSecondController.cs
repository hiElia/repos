...
{
    public class AirportSecondController : Controller
    {
        ...
        // GET: AirportSecond/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: AirportSecond/Create
